...
function preload() {
  // Load your images
  image1 = loadImage('images/FatR.png');
  image2 = loadImage('images/BlankR.png');
  // img = loadImage('Cap.png');
  bgImg = loadImage('images/bg3.png');
  image3 = loadImage('images/droper.png');
  frontflask = loadImage('images/frontflask2.png');
  frontflask2 = loadImage('images/frontflask1.png');
