...
function preload() {
  // Load your images
  image1 = loadImage('images/Fatjar.png');
  imageKOH = loadImage('images/KOHjar.png');
  img = loadImage('images/Cap.png');

  bgImg = loadImage('images/bg3.png');
  image3 = loadImage('images/droper.png');
  frontflask = loadImage('images/RBFat.png');
  frontflask2 = loadImage('images/RBBlank.png');
  waterbath1 = loadImage('images/waterbath.png');
